...
function PannelloPrima() {
  return (
    <div className="flex h-full w-full flex-col justify-center gap-3 bg-gradient-to-br from-zinc-100 to-zinc-200 p-6 sm:p-8">
      ...
      {[
        { icona: MessageCircleWarning, testo: "3 messaggi WhatsApp non letti da ieri sera" },
        { icona: Clock, testo: "Cliente in attesa di risposta da 40 minuti" },
        { icona: X, testo: "Doppia prenotazione sullo stesso slot, scoperta troppo tardi" },
      ].map((r) => (
...
function PannelloDopo() {
  return (
    <div className="flex h-full w-full flex-col justify-center gap-3 bg-gradient-to-br from-zinc-900 to-zinc-950 p-6 sm:p-8">
      ...
      {[
        "Cliente prenota da solo alle 23:40, tu lo scopri la mattina già confermato",
  ...
  return (
    <section className="mx-auto max-w-4xl px-5 py-20 sm:px-8">
      <Reveal className="text-center">
        <h2 className="text-sm font-medium text-violet-600">Cosa cambia davvero</h2>
      ...
      <p className="mt-3 text-center text-xs text-zinc-400">Situazioni tipiche, non dati di un cliente reale.</p>
    </section>
  );
}
